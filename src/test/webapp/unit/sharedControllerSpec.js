define(['angular'], function(angular) {
    describe('st:shared-controller', function() {
        it('should create an instance of the defined controllers and store them in the current scope', function() {
            ...
            var element = angular.element('<div><div st:shared-controller="shared1:SharedController1,shared2:SharedController2"></div></div>');
        ...
        it('should share instance between usages', function() {
            ...
            var element = angular.element(
                '<div><div id="id1" st:shared-controller="shared1:SharedController1"></div>' +
                    '<div id="id2" st:shared-controller="shared1:SharedController1"></div></div>');
            var rootScope = angular.scope();
            angular.compile(element)(rootScope);
